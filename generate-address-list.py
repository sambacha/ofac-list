...
POSSIBLE_ASSETS = ["XBT", "ETH", "XMR", "LTC", "ZEC", "DASH", "BTG", "ETC", "BSV"]
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        dest="sdn",
        type=open,
        help="the path to the sdn_advanced.xml file (can be downloaded from https://www.treasury.gov/ofac/downloads/sanctions/1.0/sdn_advanced.xml)",
        default="./sdn_advanced.xml",
    )
    parser.add_argument(
        "-f",
        "--output-format",
